window.onload = function () {
    ...
    form.addEventListener("submit", function (evento) {
        ...
        if (title.value == "") {
            errores.push("titulo no debe estar vacio");
        ...
        if (rating.value == "") {
            errores.push("calificacion no debe estar vacio");
        ...
        if (awards.value == "") {
            errores.push("premios no debe estar vacio");
        ...
        if (release_date.value == "") {
            errores.push("release date no debe estar vacio");
        ...
        if (length.value == "") {
            errores.push("duracion no debe estar vacio");
        ...
        if (genre_id.value == "") {
            errores.push("genero no debe estar vacio");
